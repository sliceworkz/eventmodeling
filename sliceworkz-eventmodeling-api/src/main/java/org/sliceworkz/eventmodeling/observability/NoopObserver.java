...
/**
 * {@link BoundedContextObserver#NOOP}: one observer and one scope, shared by everything that observes nothing.
 */
final class NoopObserver implements BoundedContextObserver {
	...
	public String toString ( ) {
		return "BoundedContextObserver.NOOP";
	}
