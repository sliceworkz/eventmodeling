...
/**
 * A wrapper for {@link AutomationContext} that captures the current tracing context
 * and ensures it is passed to all command executions and event creations.
 * <p>
 * This enables proper correlation and tagging in Micrometer metrics, as the tracing
 * information (actor, channel, correlation, transaction) is preserved and propagated
 ...
 */
public class TracingAutomationContext<DOMAIN_EVENT_TYPE, OUTBOUND_EVENT_TYPE> implements AutomationContext<DOMAIN_EVENT_TYPE, OUTBOUND_EVENT_TYPE> {

	private final AutomationContext<DOMAIN_EVENT_TYPE, OUTBOUND_EVENT_TYPE> delegate;
	private final Tracing tracing;

	public TracingAutomationContext(AutomationContext<DOMAIN_EVENT_TYPE, OUTBOUND_EVENT_TYPE> delegate, Tracing tracing) {
